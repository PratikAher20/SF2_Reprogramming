...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"F:\11.8\sf2_isp_using_uart_interface_demo_df\host_tool_and_samples\fabric_and_envm\synthesis\demo_top.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"F:\11.8\sf2_isp_using_uart_interface_demo_df\host_tool_and_samples\fabric_and_envm\constraint\io\demo_top.io.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M7500_TS \
    -pkg fg484 \
    -pdc_file {F:\11.8\sf2_isp_using_uart_interface_demo_df\host_tool_and_samples\fabric_and_envm\constraint\io\demo_top.io.pdc} \
    -merge_pdc 0
